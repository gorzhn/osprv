...
public class TemplateNumRunsAndNumInstances {
     ...
     *
     */
	static Semaphore klienti;
	static boolean buden;
	static Semaphore nekaVleze;
	static Semaphore sednuva;
	static int brojKlienti;
	static Semaphore berber;
    public static void init(int numBarbers) {
        
        buden = false;
        nekaVleze = new Semaphore(0);
        sednuva = new Semaphore(0);
        brojKlienti = 0;
        berber = new Semaphore(0);
        klienti = new Semaphore(5);
    }
