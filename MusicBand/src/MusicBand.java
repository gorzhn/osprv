...
public class MusicBand {
	  ...
	  static Semaphore gitarist;
	  static Semaphore pejach;
	  static Semaphore lock;
	  static int brojGitaristi;
	  static int brojPejachi;
	  static Semaphore spremen;
	  static Semaphore lock2;
	  static Semaphore lock3;
	  static Semaphore lock4;
    
	  public static void init() {
		//TODO: da se implementira  
		  gitarist = new Semaphore(3);
		  pejach = new Semaphore(0);
		  lock = new Semaphore(1);
		  brojGitaristi = 0;
		  brojPejachi = 0;
		  spremen = new Semaphore(0);
		  lock3 = new Semaphore(1);
		  lock2 = new Semaphore(1);
		  lock4 = new Semaphore(0);
	  }
